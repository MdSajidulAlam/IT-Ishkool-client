...
const FeaturedCourse = () => {
    return (
        <div className=''>
            <h1 className='text-4xl font-bold text-center my-24'>Featured Courses</h1>
            <div className='grid grid-cols-3 gap-4 w-4/5 mx-auto rounded-2xl bg-accent shadow-xl'>
                ...
                <div className='p-5 lg:col-span-2 md:col-span-3'>
                    ...
                    <div className='h-4/6 my-auto'>
                        <button className='btn btn-secondary w-full rounded-full text-white lg:text-2xl md:text-xl sm:text-xl'>150 Credits</button>
                    </div>
